...
const projects = [
  {
    ...
    description: "A sanctuary nestled in the Himalayan foothills, where architecture dissolves into landscape.",
  },
  {
    id: "02",
    title: "Chospa Hotel",
    ...
    description: "Raw earth tones and ancient craft traditions meet contemporary spatial thinking.",
  },
  {
    id: "03",
    ...
    description: "An educational environment designed to stimulate curiosity and collaborative thinking.",
  },
  {
    id: "04",
    ...
    description: "A space for reflection, remembrance and national identity carved in stone.",
  },
];
